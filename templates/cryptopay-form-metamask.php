    ...
    <div class="ct-div-block info-qr" style="width: 100%;">
        ...
        <div class="ct-div-block info" style="width: 100%;">
            <div class="form-animation">
                <p class="form-row form-group validate-required other" id="address_field" data-priority="10">
                ...
                <p class="form-row form-group validate-required has-value" id="network_field" data-priority="10">
                ...
                <p class="form-row form-group validate-required has-value" id="currency_field" data-priority="10">
                ...
                <p class="form-row form-group validate-required has-value" id="total_field" data-priority="10">
